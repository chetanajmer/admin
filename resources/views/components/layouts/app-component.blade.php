...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<!-- highcharts js -->
	<script src="/backend/assets/plugins/highcharts/js/highcharts.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/highcharts-more.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/variable-pie.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/solid-gauge.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/highcharts-3d.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/cylinder.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/funnel3d.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/exporting.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/export-data.js"></script>
	<script src="/backend/assets/plugins/highcharts/js/accessibility.js"></script>
