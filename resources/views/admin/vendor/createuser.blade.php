...
<div class="card">
    <div class="card-body p-4">
            ...
            <hr/>
        <form class="row g-3" action="{{ route('vendorprofile.store') }}" method="POST"> @csrf
            <div class="form-body mt-4">
                ...
                <div class="col-lg-6">
                       ...
                       @endphp
                        ...
                        <x-layouts.inputs title="Shop Name" type="text" name="shopname" value="{{ old('shopname') }}" class="form-control"  placeholder="Enter Shop number"/>

                        <div class="mb-3">
                        <label  class="form-label">Shop Address</label>
                        <textarea name="shopaddress" class="form-control"  rows="3"></textarea>
                        </div>
