		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{ route('customer_approved_transactions') }}"><i class="bx bx-right-arrow-alt"></i>Approved Transactions</a>
						</li>
						<li> <a href="{{ route('customer_pending_transactions') }}"><i class="bx bx-right-arrow-alt"></i>Pending Transactions</a>
						</li>
						<li> <a href="{{ route('customer_rejected_transactions') }}"><i class="bx bx-right-arrow-alt"></i>Rejected Transactions</a>
						</li>

					</ul>
				</li>
                <li>
					<a href="{{ route('customer_wallet_logs') }}">
						<div class="parent-icon"><i class='fadeIn animated bx bx-wallet-alt'></i>
						</div>
						<div class="menu-title">Wallet Logs</div>
					</a>
				</li>

                <li>
					<a href="{{ route('customer_vendorlist') }}">
						<div class="parent-icon"><i class='fadeIn animated bx bx-user-pin'></i>
						</div>
						<div class="menu-title">Available Vendors</div>
					</a>
				</li>
				...
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
                            <li  ><a class="dropdown-item"><strong>Available Balance:</strong> {{ Auth::user()->wallet }}</a></li>
